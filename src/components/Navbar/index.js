...
export default function Navbar() {
  ...
  if (!isMounted) {
    return null; // Return nothing before the component is mounted
  }
    ...
    <header className="bg-black text-white">
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        <nav className="hidden md:flex space-x-6 text-sm uppercase">
          ...
          <Link href='/properties/all' className="hover:text-gold">
            Properties
          </Link>
          <Link href='https://www.22workspace.com/' className="hover:text-gold">
            Co-work
      ...
      >
        <div className="p-4 space-y-4 flex flex-col items-start">
          <Link href='/about-us' className="block py-2 border-b border-gray-600">
            About Us
          </Link>
          <Link href='/properties/all' className="block py-2 border-b border-gray-600">
            Properties
          </Link>
          <Link href='https://www.22workspace.com/' className="block py-2 border-b border-gray-600">
            Co-work
          </Link>
          <Link href="/contact" className="block py-2 border-b border-gray-600">
            Contact Us
          </Link>
